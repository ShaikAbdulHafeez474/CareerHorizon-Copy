        ...
        <div className='flex justify-between items-center'>
            ...
            </div>
            {
                recruiter ? "" : <div className='flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto'>
                    ...
                    />
                    <Button onClick={searchJobHandler} className="rounded-r-full bg-gradient-to-b from-[#0B535B] to-[#412B5E]">
                        <Search className='h-5 w-5' />
                    </Button>
                </div>
            }
            ...
            <div>
                {
                    !user ? (
                        <div className='flex items-center gap-2'>
                            ...
                            <Link to="/signup"><Button className="bg-gradient-to-b from-[#0B535B] to-[#412B5E] hover:bg-[#5563eb]">Signup</Button></Link>
                        </div>
                    ) : (
