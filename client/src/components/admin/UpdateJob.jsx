                        ...
                        <form onSubmit={submitHandler} className='p-8 max-w-4xl border border-gray-200 shadow-lg rounded-md'>
                            <div className='grid grid-cols-2 gap-2'>
                                ...
                                <div>
                                    ...
                                    <Input type="number" name="position" value={input.position || 0} onChange={changeEventHandler} />
                                </div>
                                {companies.length > 0 && (
                            ...
                            {loading
                                ? <Button disabled className="w-full my-4"><Loader2 className='mr-2 h-4 w-4 animate-spin' /> Updating...</Button>
