    ...
    return (
        <div>
            <button
                ...
                className='bg-gradient-to-b from-[#0B535B] to-[#412B5E] text-white px-4 py-2 rounded'
            >
                Apply Filter
            </button>

            {isFilterVisible && (
                <div className='w-auto bg-gradient-to-b from-[#0B535B] to-[#412B5E] text-white p-3 rounded-md'>
                    <h1 className='font-bold text-lg'>Filter Jobs</h1>
                    <hr className='mt-3' />
